  ...
  return (
    <div className="fixed inset-0 z-40 flex justify-end overflow-hidden">
      ...
      <div
        ...
        className="relative z-10 h-full w-full max-w-xs sm:max-w-md overflow-y-auto border-l border-border/15 bg-surface p-4 sm:p-6 shadow-2xl animate-[drawerIn_220ms_ease] [-webkit-overflow-scrolling:touch]"
      >
