...
export function Modal({ open, onClose, title, children, maxWidthClassName = "max-w-lg" }: ModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-40 flex items-center justify-center p-4">
      ...
      <div
        className={`relative z-10 w-full ${maxWidthClassName} max-h-[90vh] overflow-y-auto rounded-xl border border-border/15 bg-surface p-6 shadow-2xl animate-[modalIn_180ms_ease]`}
      >
